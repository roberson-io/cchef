...
> **Status:** a curated, growing subset — **504 operations** so far, each a
...
The 504 operations are grouped using the same categories as CyberChef. Each page
...
- [`ulikunitz/xz`](https://github.com/ulikunitz/xz) — LZMA codec backing the
  LZMA Compress and LZMA Decompress operations.
