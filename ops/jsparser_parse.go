...
// nodes are built as ordered jsObject values mirroring esprima's Node
...
func jsNodeScript(body []any) jsObject {
	return jsObject{{k: "type", v: "Program"}, {k: "body", v: body}, {k: "sourceType", v: "script"}}
}

func jsNodeExpressionStatement(expr any) jsObject {
	return jsObject{{k: "type", v: "ExpressionStatement"}, {k: "expression", v: expr}}
}

func jsNodeDirective(expr any, directive string) jsObject {
	return jsObject{{k: "type", v: "ExpressionStatement"}, {k: "expression", v: expr}, {k: "directive", v: directive}}
}

func jsNodeEmptyStatement() jsObject {
	return jsObject{{k: "type", v: "EmptyStatement"}}
}

func jsNodeBlockStatement(body []any) jsObject {
	return jsObject{{k: "type", v: "BlockStatement"}, {k: "body", v: body}}
}

func jsNodeLiteral(value any, raw string) jsObject {
	return jsObject{{k: "type", v: "Literal"}, {k: "value", v: value}, {k: "raw", v: raw}}
}

func jsNodeIdentifier(name string) jsObject {
	return jsObject{{k: "type", v: "Identifier"}, {k: "name", v: name}}
}

func jsNodeBinary(op string, left, right any) jsObject {
	typ := "BinaryExpression"
	if op == "||" || op == "&&" {
		typ = "LogicalExpression"
	}
	return jsObject{{k: "type", v: typ}, {k: "operator", v: op}, {k: "left", v: left}, {k: "right", v: right}}
}

func jsNodeUnary(op string, arg any) jsObject {
	return jsObject{{k: "type", v: "UnaryExpression"}, {k: "operator", v: op}, {k: "argument", v: arg}, {k: "prefix", v: true}}
}

func jsNodeUpdate(op string, arg any, prefix bool) jsObject {
	return jsObject{{k: "type", v: "UpdateExpression"}, {k: "operator", v: op}, {k: "argument", v: arg}, {k: "prefix", v: prefix}}
}

func jsNodeAssignment(op string, left, right any) jsObject {
	return jsObject{{k: "type", v: "AssignmentExpression"}, {k: "operator", v: op}, {k: "left", v: left}, {k: "right", v: right}}
}

func jsNodeConditional(test, cons, alt any) jsObject {
	return jsObject{{k: "type", v: "ConditionalExpression"}, {k: "test", v: test}, {k: "consequent", v: cons}, {k: "alternate", v: alt}}
}

func jsNodeSequence(exprs []any) jsObject {
	return jsObject{{k: "type", v: "SequenceExpression"}, {k: "expressions", v: exprs}}
}

func jsNodeStaticMember(obj, prop any) jsObject {
	return jsObject{{k: "type", v: "MemberExpression"}, {k: "computed", v: false}, {k: "object", v: obj}, {k: "property", v: prop}}
}

func jsNodeComputedMember(obj, prop any) jsObject {
	return jsObject{{k: "type", v: "MemberExpression"}, {k: "computed", v: true}, {k: "object", v: obj}, {k: "property", v: prop}}
}

func jsNodeCall(callee any, args []any) jsObject {
	return jsObject{{k: "type", v: "CallExpression"}, {k: "callee", v: callee}, {k: "arguments", v: args}}
}

func jsNodeThis() jsObject { return jsObject{{k: "type", v: "ThisExpression"}} }

func jsNodeRegexLiteral(raw, pattern, flags string) jsObject {
	regex := jsObject{{k: "pattern", v: pattern}, {k: "flags", v: flags}}
	return jsObject{{k: "type", v: "Literal"}, {k: "value", v: jsObject{}}, {k: "raw", v: raw}, {k: "regex", v: regex}}
}

func jsNodeArray(elements []any) jsObject {
	return jsObject{{k: "type", v: "ArrayExpression"}, {k: "elements", v: elements}}
}

func jsNodeObject(properties []any) jsObject {
	return jsObject{{k: "type", v: "ObjectExpression"}, {k: "properties", v: properties}}
}

func jsNodeProperty(kind string, key, value any, computed, method, shorthand bool) jsObject {
	return jsObject{
		{k: "type", v: "Property"},
		{k: "key", v: key},
...
func jsNodeSpreadElement(arg any) jsObject {
	return jsObject{{k: "type", v: "SpreadElement"}, {k: "argument", v: arg}}
}

func jsNodeRestElement(arg any) jsObject {
	return jsObject{{k: "type", v: "RestElement"}, {k: "argument", v: arg}}
}

func jsNodeNew(callee any, args []any) jsObject {
	return jsObject{{k: "type", v: "NewExpression"}, {k: "callee", v: callee}, {k: "arguments", v: args}}
}

func jsNodeMetaProperty(meta, property any) jsObject {
	return jsObject{{k: "type", v: "MetaProperty"}, {k: "meta", v: meta}, {k: "property", v: property}}
}

func jsNodeYield(argument any, delegate bool) jsObject {
	return jsObject{{k: "type", v: "YieldExpression"}, {k: "argument", v: argument}, {k: "delegate", v: delegate}}
}

func jsNodeArrayPattern(elements []any) jsObject {
	return jsObject{{k: "type", v: "ArrayPattern"}, {k: "elements", v: elements}}
}

func jsNodeObjectPattern(properties []any) jsObject {
	return jsObject{{k: "type", v: "ObjectPattern"}, {k: "properties", v: properties}}
}

func jsNodeAssignmentPattern(left, right any) jsObject {
	return jsObject{{k: "type", v: "AssignmentPattern"}, {k: "left", v: left}, {k: "right", v: right}}
}

func jsNodeVariableDeclaration(decls []any, kind string) jsObject {
	return jsObject{{k: "type", v: "VariableDeclaration"}, {k: "declarations", v: decls}, {k: "kind", v: kind}}
}

func jsNodeVariableDeclarator(id, init any) jsObject {
	return jsObject{{k: "type", v: "VariableDeclarator"}, {k: "id", v: id}, {k: "init", v: init}}
}

func jsNodeFunction(kind string, id, params, body any, generator, async bool) jsObject {
	return jsObject{
		{k: "type", v: kind},
		{k: "id", v: id},
		{k: "params", v: params},
...
func jsNodeArrowFunction(params []any, body any, expression, async bool) jsObject {
	return jsObject{
...
func jsNodeAwait(argument any) jsObject {
	return jsObject{{k: "type", v: "AwaitExpression"}, {k: "argument", v: argument}}
}

func jsNodeSuper() jsObject { return jsObject{{k: "type", v: "Super"}} }

func jsNodeClass(kind string, id, superClass, body any) jsObject {
	return jsObject{
		{k: "type", v: kind},
		{k: "id", v: id},
...
func jsNodeClassBody(body []any) jsObject {
	return jsObject{{k: "type", v: "ClassBody"}, {k: "body", v: body}}
}

func jsNodeMethodDefinition(key any, computed bool, value any, kind string, static bool) jsObject {
	return jsObject{
...
func jsNodeIf(test, cons, alt any) jsObject {
	return jsObject{{k: "type", v: "IfStatement"}, {k: "test", v: test}, {k: "consequent", v: cons}, {k: "alternate", v: alt}}
}

func jsNodeWhile(test, body any) jsObject {
	return jsObject{{k: "type", v: "WhileStatement"}, {k: "test", v: test}, {k: "body", v: body}}
}

func jsNodeDoWhile(body, test any) jsObject {
	return jsObject{{k: "type", v: "DoWhileStatement"}, {k: "body", v: body}, {k: "test", v: test}}
}

func jsNodeFor(init, test, update, body any) jsObject {
	return jsObject{{k: "type", v: "ForStatement"}, {k: "init", v: init}, {k: "test", v: test}, {k: "update", v: update}, {k: "body", v: body}}
}

func jsNodeForIn(left, right, body any) jsObject {
	return jsObject{{k: "type", v: "ForInStatement"}, {k: "left", v: left}, {k: "right", v: right}, {k: "body", v: body}, {k: "each", v: false}}
}

func jsNodeForOf(left, right, body any) jsObject {
	return jsObject{{k: "type", v: "ForOfStatement"}, {k: "left", v: left}, {k: "right", v: right}, {k: "body", v: body}}
}

func jsNodeReturn(arg any) jsObject {
	return jsObject{{k: "type", v: "ReturnStatement"}, {k: "argument", v: arg}}
}

func jsNodeBreak(label any) jsObject {
	return jsObject{{k: "type", v: "BreakStatement"}, {k: "label", v: label}}
}

func jsNodeContinue(label any) jsObject {
	return jsObject{{k: "type", v: "ContinueStatement"}, {k: "label", v: label}}
}

func jsNodeThrow(arg any) jsObject {
	return jsObject{{k: "type", v: "ThrowStatement"}, {k: "argument", v: arg}}
}

func jsNodeSwitch(disc any, cases []any) jsObject {
	return jsObject{{k: "type", v: "SwitchStatement"}, {k: "discriminant", v: disc}, {k: "cases", v: cases}}
}

func jsNodeSwitchCase(test any, consequent []any) jsObject {
	return jsObject{{k: "type", v: "SwitchCase"}, {k: "test", v: test}, {k: "consequent", v: consequent}}
}

func jsNodeTry(block, handler, finalizer any) jsObject {
	return jsObject{{k: "type", v: "TryStatement"}, {k: "block", v: block}, {k: "handler", v: handler}, {k: "finalizer", v: finalizer}}
}

func jsNodeCatch(param, body any) jsObject {
	return jsObject{{k: "type", v: "CatchClause"}, {k: "param", v: param}, {k: "body", v: body}}
}

func jsNodeWith(obj, body any) jsObject {
	return jsObject{{k: "type", v: "WithStatement"}, {k: "object", v: obj}, {k: "body", v: body}}
}

func jsNodeLabeled(label, body any) jsObject {
	return jsObject{{k: "type", v: "LabeledStatement"}, {k: "label", v: label}, {k: "body", v: body}}
}

func jsNodeDebugger() jsObject { return jsObject{{k: "type", v: "DebuggerStatement"}} }

func jsNodeTemplateElement(raw, cooked string, tail bool) jsObject {
	value := jsObject{{k: "raw", v: raw}, {k: "cooked", v: cooked}}
	return jsObject{{k: "type", v: "TemplateElement"}, {k: "value", v: value}, {k: "tail", v: tail}}
}

func jsNodeTemplateLiteral(quasis, expressions []any) jsObject {
	return jsObject{{k: "type", v: "TemplateLiteral"}, {k: "quasis", v: quasis}, {k: "expressions", v: expressions}}
}

func jsNodeTaggedTemplate(tag, quasi any) jsObject {
	return jsObject{{k: "type", v: "TaggedTemplateExpression"}, {k: "tag", v: tag}, {k: "quasi", v: quasi}}
}

// jsNodeType returns the "type" field of an AST node.
func jsNodeType(n any) string {
	obj, ok := n.(jsObject)
	if !ok {
		return ""
	}
...
type jsParser struct {
	...
	track   bool       // when set, node ranges and tokens are collected (jsParseFull)
	tokens  []jsObject // collected tokens (type/value/range), source order
...
func (p *jsParser) convertToken(t jsToken) jsObject {
	return jsObject{
...
// last consumed token's end. Non-jsObject values (arrow placeholders) and the
// untracked path pass through unchanged.
func (p *jsParser) finalize(start int, node any) any {
	if !p.track {
		return node
	}
	obj, ok := node.(jsObject)
	if !ok {
		return node
	}
	return append(obj, jsPair{k: "range", v: []any{float64(start), float64(p.lastEnd)}})
}
...
func (p *jsParser) carryRange(src, dst any) any {
	...
	return append(obj, jsPair{k: "range", v: r})
}
...
func (p *jsParser) finishGroupArrow(expr any) any {
	if jsNodeType(expr) == "Identifier" && jsIdentName(expr) == "yield" {
		return jsArrowParams{params: []any{expr}}
	}
	if !p.context.isBindingElement {
		p.throwUnexpectedToken(p.lookahead)
	}
	if jsNodeType(expr) == "SequenceExpression" {
		seq := jsFieldSlice(expr, "expressions")
...
// jsFieldSlice returns the []any value of the named node field.
func jsFieldSlice(n any, field string) []any {
	obj, _ := n.(jsObject)
	for _, pr := range obj {
		if pr.k == field {
			s, _ := pr.v.([]any)
...
func (p *jsParser) parseExponentiationExpression() any {
	start := p.lookahead.start
	expr := p.inheritCoverGrammar(p.parseUnaryExpression)
	if jsNodeType(expr) != "UnaryExpression" && p.match("**") {
		p.nextToken()
		p.context.isAssignmentTarget = false
		p.context.isBindingElement = false
...
func (p *jsParser) finishArrowFunction(start int, list []any, isAsync bool) any {
	...
	expression := jsNodeType(body) != "BlockStatement"
...
func (p *jsParser) parseScript() jsObject {
	start := p.lookahead.start
	body := p.parseDirectivePrologues()
	for p.lookahead.typ != tkEOF {
		body = append(body, p.parseStatementListItem())
	}
	return p.finalize(start, jsNodeScript(body)).(jsObject)
}

// jsIdentName returns the "name" field of an Identifier node.
func jsIdentName(n any) string {
	obj, _ := n.(jsObject)
	for _, pr := range obj {
		if pr.k == "name" {
			s, _ := pr.v.(string)
...
// jsField returns the value of the named node field, or nil.
func jsField(n any, field string) any {
	obj, _ := n.(jsObject)
	for _, pr := range obj {
		if pr.k == field {
			return pr.v
...
func (p *jsParser) reinterpretExpressionAsPattern(expr any) any {
	switch jsNodeType(expr) {
	case "SpreadElement":
		arg := p.reinterpretExpressionAsPattern(jsField(expr, "argument"))
		return p.carryRange(expr, jsObject{{k: "type", v: "RestElement"}, {k: "argument", v: arg}})
	case "ArrayExpression":
		...
		return p.carryRange(expr, jsObject{{k: "type", v: "ArrayPattern"}, {k: "elements", v: out}})
	case "ObjectExpression":
		...
		return p.carryRange(expr, jsObject{{k: "type", v: "ObjectPattern"}, {k: "properties", v: out}})
	case "AssignmentExpression":
		left := p.reinterpretExpressionAsPattern(jsField(expr, "left"))
		return p.carryRange(expr, jsObject{{k: "type", v: "AssignmentPattern"}, {k: "left", v: left}, {k: "right", v: jsField(expr, "right")}})
	}
...
func (p *jsParser) reinterpretPropertyValue(prop any) any {
	obj, _ := prop.(jsObject)
	out := make(jsObject, len(obj))
	for i, pr := range obj {
		if pr.k == "value" {
			out[i] = jsPair{k: "value", v: p.reinterpretExpressionAsPattern(pr.v)}
		} else {
			out[i] = pr
		}
	}
...
// jsFieldBool returns the bool value of the named node field.
func jsFieldBool(n any, field string) bool {
	obj, _ := n.(jsObject)
	for _, pr := range obj {
		if pr.k == field {
			b, _ := pr.v.(bool)
...
func (p *jsParser) parseSetterMethod() any {
	...
	} else if jsNodeType(params[0]) == "RestElement" {
...
func jsIsPropertyKey(key any, name string) bool {
	switch jsNodeType(key) {
	case "Identifier":
		return jsIdentName(key) == name
	case "Literal":
		v, _ := jsField(key, "value").(string)
		return v == name
	}
	return false
}
...
func (p *jsParser) parseClassElementHead() (token jsToken, key any, computed, isStatic, isAsync bool) {
	...
	computed = p.match("[")
	key = p.parseObjectPropertyKey()
	if jsIdentName(key) == "static" && (p.qualifiedPropertyName(p.lookahead) || p.match("*")) {
		token = p.lookahead
		isStatic = true
		computed = p.match("[")
		if p.match("*") {
...
func (p *jsParser) checkClassSpecialKey(token jsToken, key any, kind string, method bool, value any, isStatic bool, hasConstructor *bool) string {
	...
	if !isStatic && jsIsPropertyKey(key, "constructor") {
		if kind != "method" || !method || jsFieldBool(value, "generator") {
...
func (p *jsParser) parseVariableDeclaration(inFor bool) any {
	...
	} else if jsNodeType(id) != "Identifier" && !inFor {
		p.expect("=")
	}
...
func (p *jsParser) parseLexicalBinding(kind string, inFor bool) any {
	...
	} else if (!inFor && jsNodeType(id) != "Identifier") || p.match("=") {
		p.expect("=")
		init = p.isolateCoverGrammar(p.parseAssignmentExpression)
	}
	return p.finalize(start, jsNodeVariableDeclarator(id, init))
...
func (p *jsParser) parseForExprHead() jsForHead {
	...
	case p.matchKeyword("in"):
		if !p.context.isAssignmentTarget || jsNodeType(init) == "AssignmentExpression" {
...
func (p *jsParser) parseContinueStatement() any {
	...
	if p.lookahead.typ == tkIdentifier && !p.hasLineTerminator {
		id := p.parseVariableIdentifier("")
		label = id
		if !p.context.labelSet["$"+jsIdentName(id)] {
			p.throwError("Undefined label '" + jsIdentName(id) + "'")
		}
	}
	p.consumeSemicolon()
...
func (p *jsParser) parseLabelledStatement() any {
	start := p.lookahead.start
	expr := p.parseExpression()
	if jsNodeType(expr) == "Identifier" && p.match(":") {
		p.nextToken()
		name := jsIdentName(expr)
		key := "$" + name
...
// jsParse parses the source and returns the ESTree AST as a jsObject, or a
// *jsSyntaxError (recovered from the panic-based control flow).
func jsParse(code string) (ast jsObject, err error) {
	defer func() {
		if r := recover(); r != nil {
...
// jsParseFull parses the source with esprima's range/tokens/comment options
// enabled: every AST node carries a range, and flat comments/tokens arrays are
// returned in source order. On a syntax error it returns the error like jsParse.
func jsParseFull(code string) (ast jsObject, comments []jsObject, tokens []jsObject, err error) {
	defer func() {
		if r := recover(); r != nil {
			if se, ok := r.(*jsSyntaxError); ok {
				err = se
...
func jsRangeStart(n any) int {
	if r, ok := jsField(n, "range").([]any); ok && len(r) == 2 {
