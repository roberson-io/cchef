...
> **Scope:** 435 operations are currently ported, covering the whole architecture.
...
| [Other](other.md) | Analyse UUID, Chi Square, Disassemble ARM, Disassemble x86, Entropy, Frequency distribution, Generate HOTP, Generate QR Code, Generate TOTP, Generate UUID, Index of Coincidence, Parse QR Code, Pseudo-Random Number Generator |
