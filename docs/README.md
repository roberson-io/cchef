...
> **Scope:** 497 operations are currently ported, covering the whole architecture.
...
| [Flow control](flow-control.md) | Comment, Conditional Jump, Fork, Jump, Label, Merge, Register, Return, Subsection |
