...
> **Scope:** 427 operations are currently ported, covering the whole architecture.
...
| [Other](other.md) | Disassemble ARM, Disassemble x86, Generate QR Code, Parse QR Code, Pseudo-Random Number Generator |
