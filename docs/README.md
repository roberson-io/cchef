...
> **Scope:** 404 operations are currently ported, covering the whole architecture.
...
| [Multimedia](multimedia.md) | Extract EXIF, Flip Image, Image Filter, Image Opacity, Invert Image, Play Media, Remove EXIF, Render Image, Render PDF, Rotate Image |
