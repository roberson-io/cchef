...
> **Scope:** 431 operations are currently ported, covering the whole architecture.
...
| [Other](other.md) | Chi Square, Disassemble ARM, Disassemble x86, Entropy, Frequency distribution, Generate QR Code, Index of Coincidence, Parse QR Code, Pseudo-Random Number Generator |
