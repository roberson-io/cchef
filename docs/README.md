...
> **Scope:** 439 operations are currently ported, covering the whole architecture.
...
| [Other](other.md) | Analyse UUID, Chi Square, Disassemble ARM, Disassemble x86, Entropy, Frequency distribution, Generate HOTP, Generate Lorem Ipsum, Generate QR Code, Generate TOTP, Generate UUID, Index of Coincidence, Numberwang, P-list Viewer, Parse QR Code, Pseudo-Random Integer Generator, Pseudo-Random Number Generator |
