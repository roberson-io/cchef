...
> **Scope:** 345 operations are currently ported, covering the whole architecture.
...
| [Hashing](hashing.md) | Adler-32 Checksum, Bcrypt, Bcrypt compare, Bcrypt parse, CRC Checksum, Fletcher-16 Checksum, Fletcher-32 Checksum, Fletcher-64 Checksum, Fletcher-8 Checksum, GOST Hash, HAS-160, HMAC, Keccak, Luhn Checksum, MD2, MD4, MD5, Parity Bit, RIPEMD, Scrypt, SHA0, SHA1, SHA224, SHA256, SHA3, SHA384, SHA512, SM3, Snefru, TCP/IP Checksum, Whirlpool, XOR Checksum |
