...
> **Scope:** 213 operations are currently ported, covering the whole architecture.
...
| [Encryption / Encoding](encryption-encoding.md) | A1Z26 Cipher Decode, A1Z26 Cipher Encode, ADD, AND, Bit shift left, Bit shift right, NOT, OR, ROR13, ROT13, ROT47, ROT8000, Rotate left, Rotate right, SUB, XOR, XOR Brute Force |
