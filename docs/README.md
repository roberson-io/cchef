...
> **Scope:** 478 operations are currently ported, covering the whole architecture.
...
| [Forensics](forensics.md) | Detect File Type, Extract Audio Metadata, Extract EXIF, Extract Files, Remove EXIF, YARA Rules |
