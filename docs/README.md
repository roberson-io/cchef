...
> **Scope:** 399 operations are currently ported, covering the whole architecture.
...
| [Multimedia](multimedia.md) | Extract EXIF, Play Media, Remove EXIF, Render Image, Render PDF |
