...
> **Scope:** 414 operations are currently ported, covering the whole architecture.
...
| [Multimedia](multimedia.md) | Blur Image, Contain Image, Cover Image, Crop Image, Dither Image, Extract EXIF, Flip Image, Image Brightness / Contrast, Image Filter, Image Hue/Saturation/Lightness, Image Opacity, Invert Image, Normalise Image, Play Media, Remove EXIF, Render Image, Render PDF, Resize Image, Rotate Image, Sharpen Image |
