...
> **Scope:** 397 operations are currently ported, covering the whole architecture.
...
| [Forensics](forensics.md) | Detect File Type |
...
| [Multimedia](multimedia.md) | Play Media, Render Image, Render PDF |
