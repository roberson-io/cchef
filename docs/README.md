...
> **Scope:** 312 operations are currently ported, covering the whole architecture.
...
| [Public Key](public-key.md) | ECDSA Sign, ECDSA Signature Conversion, ECDSA Verify, Generate ECDSA Key Pair, Hex to PEM, PEM to Hex, Parse ASN.1 hex string, Parse SSH Host Key |
