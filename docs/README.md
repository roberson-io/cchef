...
> **Scope:** 447 operations are currently ported, covering the whole architecture.
...
| [Extractors](extractors.md) | CSS selector, Extract Audio Metadata, Extract EXIF, Extract Files, Extract ID3, Extract dates, JPath expression, Regular expression, XPath expression |
