...
> **Scope:** 452 operations are currently ported, covering the whole architecture.
...
| [Extractors](extractors.md) | CSS selector, Extract Audio Metadata, Extract EXIF, Extract Files, Extract ID3, Extract IP addresses, Extract dates, JPath expression, Jsonata Query, RAKE, Regular expression, Strings, Template, XPath expression |
| [Forensics](forensics.md) | Detect File Type, Extract Audio Metadata, Extract EXIF, Extract Files, Remove EXIF |
