...
> **Scope:** 246 operations are currently ported, covering the whole architecture.
...
| [Encryption / Encoding](encryption-encoding.md) | A1Z26 Cipher Decode, A1Z26 Cipher Encode, ADD, AES Decrypt, AES Encrypt, AES Key Unwrap, AES Key Wrap, Affine Cipher Decode, Affine Cipher Encode, AND, Ascon Decrypt, Ascon Encrypt, Atbash Cipher, Bacon Cipher Decode, Bacon Cipher Encode, Bcrypt, Bifid Cipher Decode, Bifid Cipher Encode, Bit shift left, Bit shift right, Blowfish Decrypt, Blowfish Encrypt, Bombe, Caesar Box Cipher, Cetacean Cipher Decode, Cetacean Cipher Encode, ChaCha, CipherSaber2 Decrypt, CipherSaber2 Encrypt, Citrix CTX1 Decode, Citrix CTX1 Encode, Colossus, Derive EVP key, Derive HKDF key, Enigma, Lorenz, Multiple Bombe, NOT, OR, ROR13, ROT13, ROT47, ROT8000, Rotate left, Rotate right, SUB, XOR, XOR Brute Force |
| [Hashing](hashing.md) | Adler-32 Checksum, Bcrypt, Bcrypt compare, Bcrypt parse, HMAC, Keccak, MD5, SHA1, SHA224, SHA256, SHA3, SHA384, SHA512 |
