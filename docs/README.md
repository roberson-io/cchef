...
> **Scope:** 508 operations, covering every CyberChef operation. Run `cchef list`
...
| [Compression](compression.md) | Bzip2 Compress, Bzip2 Decompress, Gunzip, Gzip, LZ4 Compress, LZ4 Decompress, LZMA Compress, LZMA Decompress, LZNT1 Decompress, LZString Compress, LZString Decompress, Raw Deflate, Raw Inflate, Tar, Untar, Unzip, XPRESS Decompress, XPRESS LZ77+Huffman Decompress, Zip, Zlib Deflate, Zlib Inflate |
