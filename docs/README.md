...
> **Scope:** 470 operations are currently ported, covering the whole architecture.
...
| [Compression](compression.md) | Bzip2 Compress, Bzip2 Decompress, Gunzip, Gzip, LZMA Compress, LZMA Decompress, Raw Deflate, Raw Inflate, Unzip, Zip, Zlib Deflate, Zlib Inflate |
