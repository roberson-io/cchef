...
> **Scope:** 370 operations are currently ported, covering the whole architecture.
...
| [Code tidy](code-tidy.md) | CSS selector, Diff, From MessagePack, JavaScript Beautify, JavaScript Minify, JavaScript Parser, To MessagePack |
...
| [Extractors](extractors.md) | CSS selector, Extract dates, Regular expression |
