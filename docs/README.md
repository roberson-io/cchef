...
> **Scope:** 385 operations are currently ported, covering the whole architecture.
...
| [Code tidy](code-tidy.md) | BSON deserialise, BSON serialise, CSS Beautify, CSS Minify, CSS selector, Diff, From MessagePack, JavaScript Beautify, JavaScript Minify, JavaScript Parser, JPath expression, Jq, JSON Beautify, JSON Minify, Render Markdown, SQL Beautify, SQL Minify, Syntax highlighter, To MessagePack, XML Beautify, XML Minify, XPath expression |
...
| [Extractors](extractors.md) | CSS selector, Extract dates, JPath expression, Regular expression, XPath expression |
