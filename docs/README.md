...
> **Scope:** 333 operations are currently ported, covering the whole architecture.
...
| [Hashing](hashing.md) | Adler-32 Checksum, Bcrypt, Bcrypt compare, Bcrypt parse, GOST Hash, HAS-160, HMAC, Keccak, MD2, MD4, MD5, RIPEMD, Scrypt, SHA0, SHA1, SHA224, SHA256, SHA3, SHA384, SHA512, Snefru, Whirlpool |
...
| [Public Key](public-key.md) | ECDSA Sign, ECDSA Signature Conversion, ECDSA Verify, Generate ECDSA Key Pair, Generate PGP Key Pair, Generate RSA Key Pair, Hex to Object Identifier, Hex to PEM, JWK to PEM, Object Identifier to Hex, PEM to Hex, PEM to JWK, PGP Decrypt, PGP Decrypt and Verify, PGP Encrypt, PGP Encrypt and Sign, PGP Sign, PGP Verify, Parse ASN.1 hex string, Parse CSR, Parse SSH Host Key, Parse X.509 CRL, Parse X.509 certificate, Public Key from Certificate, Public Key from Private Key, RSA Decrypt, RSA Encrypt, RSA Sign, RSA Verify |
