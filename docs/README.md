...
> **Scope:** 479 operations are currently ported, covering the whole architecture.
...
| [Forensics](forensics.md) | Detect File Type, ELF Info, Extract Audio Metadata, Extract EXIF, Extract Files, Remove EXIF, YARA Rules |
