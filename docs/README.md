...
> **Scope:** 450 operations are currently ported, covering the whole architecture.
...
| [Extractors](extractors.md) | CSS selector, Extract Audio Metadata, Extract EXIF, Extract Files, Extract ID3, Extract IP addresses, Extract dates, JPath expression, RAKE, Regular expression, Strings, XPath expression |
