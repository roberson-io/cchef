...
> **Scope:** 445 operations are currently ported, covering the whole architecture.
...
| [Extractors](extractors.md) | CSS selector, Extract EXIF, Extract Files, Extract dates, JPath expression, Regular expression, XPath expression |
| [Forensics](forensics.md) | Detect File Type, Extract EXIF, Extract Files, Remove EXIF |
