...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 279
...
- **279 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **276 unique** CyberChef operations are covered (275 directly plus
