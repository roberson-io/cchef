...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 301
...
- **301 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **298 unique** CyberChef operations are covered (297 directly plus
