...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 206
...
- **206 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **203 unique** CyberChef operations are covered (202 directly plus
