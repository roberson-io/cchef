...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 237
...
- **237 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **234 unique** CyberChef operations are covered (233 directly plus
