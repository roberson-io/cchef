...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 497
...
- **497 operations** (`internal/ops/`), each a faithful port with tests
...
40k LOC) implementing the ~497 registered operations. Nothing about it is broken;
...
than one category.
Currently **494 unique** CyberChef operations are covered (493 directly plus
`SHA2`, exposed as the `sha224`, `sha256`, `sha384` and `sha512` subcommands),
which is where the 497 cchef subcommands come from.
...
- [x] Convert Leet Speak
- [x] Convert to NATO alphabet
- [x] Decode text
- [x] Encode text
- [x] Remove Diacritics
- [x] Unescape Unicode Characters
- [x] Unicode Text Format
...
- [x] Extract LSB
- [x] Extract RGBA
- [x] Randomize Colour Palette
- [x] Remove EXIF
- [x] Scan for Embedded Files
- [x] View Bit Plane
- [x] YARA Rules
