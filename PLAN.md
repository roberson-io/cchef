...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 238
...
- **238 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **235 unique** CyberChef operations are covered (234 directly plus
