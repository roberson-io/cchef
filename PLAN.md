...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 280
...
- **280 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **277 unique** CyberChef operations are covered (276 directly plus
