...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 354
...
- **354 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **344 unique** CyberChef operations are covered (343 directly plus
