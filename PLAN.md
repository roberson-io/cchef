...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 277
...
- **277 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **274 unique** CyberChef operations are covered (273 directly plus
