...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 185
...
- **185 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **182 unique** CyberChef operations are covered (181 directly plus
