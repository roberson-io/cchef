...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 356
...
- **356 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **346 unique** CyberChef operations are covered (345 directly plus
