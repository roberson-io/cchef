...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 303
...
- **303 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **300 unique** CyberChef operations are covered (299 directly plus
