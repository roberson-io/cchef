...
The core engine, recipe/URL machinery, CLI, docs, and a **curated set of 359
...
- **359 operations** (`internal/ops/`), each a faithful port with tests
...
than one category.
Currently **349 unique** CyberChef operations are covered (348 directly plus
