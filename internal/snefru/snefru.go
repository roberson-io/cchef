...
//
// Snefru is parameterised by its output size and the number of passes it makes
// over each block; [NewWithParams] takes both, and [New] uses the sizes
// CyberChef offers by default.
package snefru
