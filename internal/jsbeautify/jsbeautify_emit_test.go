...
func TestJSNodeKeyRangeGuards(t *testing.T) {
	noRange := jsonval.Object{{K: "type", V: "Identifier"}}
	badLen := jsonval.Object{{K: "type", V: "Identifier"}, {K: "range", V: []any{float64(0)}}}
	...
	good := jsonval.Object{{K: "type", V: "Identifier"}, {K: "range", V: []any{float64(2), float64(5)}}}
...
func TestJSGenCommentNilGuards(t *testing.T) {
	...
	node := jsonval.Object{{K: "type", V: "Identifier"}, {K: "range", V: []any{float64(0), float64(1)}}}
