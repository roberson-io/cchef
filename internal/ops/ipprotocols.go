...
// ipProtocol is a protocol-number registry entry (IANA), used by Parse IPv4 header.
type ipProtocol struct {
	keyword  string
	protocol string
}

// protocolLookup mirrors CyberChef lib/IP.mjs protocolLookup (IANA protocol numbers).
var protocolLookup = map[int]ipProtocol{
