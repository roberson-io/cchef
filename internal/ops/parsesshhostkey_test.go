...
// TestParseSSHHostKeyAutoDetectFailure covers Auto format on input that is
// neither hex nor base64.
func TestParseSSHHostKeyAutoDetectFailure(t *testing.T) {
	_, err := core.Recipe{{Op: "Parse SSH Host Key", Args: []any{"Auto"}}}.
		Execute(core.NewDish([]byte("not a key!!!"), core.TypeString))
	if err == nil || !strings.Contains(err.Error(), "unable to detect input key format") {
		t.Fatalf("got err %v, want detect-format error", err)
	}
}

// TestParseSSHHostKeyFixtures transcribes CyberChef's ParseSSHHostKey.mjs cases
// (expected values from the oracle). Covers RSA, ECDSA and Ed25519 key types,
// the "ssh-rsa <key> comment" prefix form, and Auto format detection.
func TestParseSSHHostKeyFixtures(t *testing.T) {
	const rsa = ""
	const rsaOut = "Key type: ssh-rsa\nExponent: 0x010001\nModulus: "
