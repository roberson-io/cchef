...
// formatExamples is CyberChef's FORMAT_EXAMPLES (lib/DateTime.mjs), appended to
// the "Invalid format." message by Parse DateTime and DateTime Delta.
const formatExamples = `Format string tokens:
