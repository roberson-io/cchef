...
func init() {
	core.Register(hashOp{name: "MD5", infoURL: "https://wikipedia.org/wiki/MD5", new: md5.New}) // #nosec G401 -- MD5 is an intentional CyberChef operation, not a security control
