...
var opSummaries = map[string]string{
	...
	"Conditional Jump":                "Jumps to a Label when the data matches a pattern",
	...
	"Extended GCD":                    "Greatest common divisor with Bezout coefficients",
	"Extract LSB":                     "Extracts least-significant-bit data from an image",
	"Remove Diacritics":               "Replaces accented characters with their plain equivalents",
	"Unicode Text Format":             "Underlines or strikes through text with combining marks",
